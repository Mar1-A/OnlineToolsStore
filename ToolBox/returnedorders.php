    ...
    <div class="">
        <div class="order-list-nav">
            <ul class="cus-nav-list">
                ...
                <li class="cus-nav-list-item" id="active"><a href="returnedorders.php">returns</a></li>

            </ul>
        </div>
        <div class="ousde-container2">
       <div class="order-detailes-wrapper">
      <table class="table">
                <tr>
                    <tr><th colspan="5"><h3>Your orders</h3></th></tr>
...
?>
    <tr>
        <td>
        order Date: <?php echo $orderDetailes['orderDate'];?><br>
        order Total: £ <?php echo $orderDetailes['orderAmount'];?>
                ...
                <br> <?php echo  $orderDetailes['orderQuantity'];?></td>
                    ...
                    <td><?php echo $orderDetailes['cusFName'];?> <?php echo $orderDetailes['cusLName'];?><br>
                        ...
                        <td><?php echo $orderDetailes['statu'];?></td>
                    </tr>
